...
Blockly.Msg.INTERNAL_TEMP = "Microcontroller temperature (°C)";

// Debug blocks
Blockly.Msg.PRINT = "Print %1 to the console";
Blockly.Msg.READ_CONSOLE = "Read text from console with request: %1";
Blockly.Msg.PYTHON = "Run python code %1";
